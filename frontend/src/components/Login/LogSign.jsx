...
const LogSign = () => {
  ...
  const handleInputChange = (index, value) => {
    ...
    // Update enteredNumbers state
    const newEnteredNumbers =
      index === 0 ? value : enteredNumbers.slice(0, index) + value;
    setEnteredNumbers(newEnteredNumbers);
  };

  return (
    <>
      <div className=" absolute     px-8 py-12  rounded-xl  bg-black/90 text-white  top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        {!oncontinue ? (
          ...
          <div className=" flex flex-col gap-5  ">
            <div className="rounded-xl  flex items-center cursor-pointer justify-center -mt-6 border  border-gray-500 w-8 h-8"
          ...
          <FaChevronLeft  className="  text-lg  text-white/60 "
           />
            ...
            <div className=" flex flex-col gap-1 mb-5">
              ...
              <h2 className=" text-sm text-white/80">please enter the 5 digit code sent to </h2>
